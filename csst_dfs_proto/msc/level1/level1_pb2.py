...
_LEVEL1RECORD_REFSENTRY = _descriptor.Descriptor(
  name='RefsEntry',
  full_name='dfs.msc.level1.Level1Record.RefsEntry',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='dfs.msc.level1.Level1Record.RefsEntry.value', index=1,
...
Level1Record = _reflection.GeneratedProtocolMessageType('Level1Record', (_message.Message,), {
  ...
  'RefsEntry' : _reflection.GeneratedProtocolMessageType('RefsEntry', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:dfs.msc.level1.Level1Record.RefsEntry)
    })
  ,

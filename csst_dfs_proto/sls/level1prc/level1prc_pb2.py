...
# source: sls/level1prc/level1prc.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='sls/level1prc/level1prc.proto',
  package='dfs.sls.level1prc',
  syntax='proto3',
  serialized_options=_b('Z\"cnlab.net/csst/proto/sls/level1prc'),
  serialized_pb=_b('\n\x1dsls/level1prc/level1prc.proto\x12\x11\x64\x66s.sls.level1prc\x1a\x12\x63ommon/error.proto\"\xb3\x01\n\x0fLevel1PrcRecord\x12\n\n\x02id\x18\x01 \x01(\x03\x12\x11\n\tlevel1_id\x18\x02 \x01(\x03\x12\x13\n\x0bpipeline_id\x18\x03 \x01(\t\x12\x12\n\nprc_module\x18\x04 \x01(\t\x12\x18\n\x10params_file_path\x18\x05 \x01(\t\x12\x12\n\nprc_status\x18\x06 \x01(\x05\x12\x10\n\x08prc_time\x18\x07 \x01(\t\x12\x18\n\x10result_file_path\x18\x08 \x01(\t\"\xee\x01\n\x10\x46indLevel1PrcReq\x12\x11\n\tlevel1_id\x18\x01 \x01(\x03\x12\x13\n\x0bpipeline_id\x18\x02 \x01(\t\x12\x12\n\nprc_module\x18\x03 \x01(\t\x12\x12\n\nprc_status\x18\x04 \x01(\x05\x12R\n\x10other_conditions\x18\x05 \x03(\x0b\x32\x38.dfs.sls.level1prc.FindLevel1PrcReq.OtherConditionsEntry\x1a\x36\n\x14OtherConditionsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t:\x02\x38\x01\"\x8b\x01\n\x11\x46indLevel1PrcResp\x12\x0f\n\x07success\x18\x01 \x01(\x08\x12\x12\n\ntotalCount\x18\x02 \x01(\x05\x12\x1c\n\x05\x65rror\x18\x03 \x01(\x0b\x32\r.common.Error\x12\x33\n\x07records\x18\x04 \x03(\x0b\x32\".dfs.sls.level1prc.Level1PrcRecord\"G\n\x11WriteLevel1PrcReq\x12\x32\n\x06record\x18\x01 \x01(\x0b\x32\".dfs.sls.level1prc.Level1PrcRecord\"w\n\x12WriteLevel1PrcResp\x12\x0f\n\x07success\x18\x01 \x01(\x08\x12\x1c\n\x05\x65rror\x18\x02 \x01(\x0b\x32\r.common.Error\x12\x32\n\x06record\x18\x03 \x01(\x0b\x32\".dfs.sls.level1prc.Level1PrcRecord\"1\n\x13UpdateProcStatusReq\x12\n\n\x02id\x18\x01 \x01(\x03\x12\x0e\n\x06status\x18\x02 \x01(\x05\"E\n\x14UpdateProcStatusResp\x12\x0f\n\x07success\x18\x01 \x01(\x08\x12\x1c\n\x05\x65rror\x18\x02 \x01(\x0b\x32\r.common.Error2\xa2\x02\n\x0cLevel1PrcSrv\x12S\n\x04\x46ind\x12#.dfs.sls.level1prc.FindLevel1PrcReq\x1a$.dfs.sls.level1prc.FindLevel1PrcResp\"\x00\x12V\n\x05Write\x12$.dfs.sls.level1prc.WriteLevel1PrcReq\x1a%.dfs.sls.level1prc.WriteLevel1PrcResp\"\x00\x12\x65\n\x10UpdateProcStatus\x12&.dfs.sls.level1prc.UpdateProcStatusReq\x1a\'.dfs.sls.level1prc.UpdateProcStatusResp\"\x00\x42$Z\"cnlab.net/csst/proto/sls/level1prcb\x06proto3')
  ,
...
_LEVEL1PRCRECORD = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.Level1PrcRecord',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='dfs.sls.level1prc.Level1PrcRecord.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='level1_id', full_name='dfs.sls.level1prc.Level1PrcRecord.level1_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pipeline_id', full_name='dfs.sls.level1prc.Level1PrcRecord.pipeline_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prc_module', full_name='dfs.sls.level1prc.Level1PrcRecord.prc_module', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='params_file_path', full_name='dfs.sls.level1prc.Level1PrcRecord.params_file_path', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prc_status', full_name='dfs.sls.level1prc.Level1PrcRecord.prc_status', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prc_time', full_name='dfs.sls.level1prc.Level1PrcRecord.prc_time', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='result_file_path', full_name='dfs.sls.level1prc.Level1PrcRecord.result_file_path', index=7,
...
_FINDLEVEL1PRCREQ_OTHERCONDITIONSENTRY = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.FindLevel1PrcReq.OtherConditionsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='dfs.sls.level1prc.FindLevel1PrcReq.OtherConditionsEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='dfs.sls.level1prc.FindLevel1PrcReq.OtherConditionsEntry.value', index=1,
...
_FINDLEVEL1PRCREQ = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.FindLevel1PrcReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='level1_id', full_name='dfs.sls.level1prc.FindLevel1PrcReq.level1_id', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pipeline_id', full_name='dfs.sls.level1prc.FindLevel1PrcReq.pipeline_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prc_module', full_name='dfs.sls.level1prc.FindLevel1PrcReq.prc_module', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prc_status', full_name='dfs.sls.level1prc.FindLevel1PrcReq.prc_status', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='other_conditions', full_name='dfs.sls.level1prc.FindLevel1PrcReq.other_conditions', index=4,
...
_FINDLEVEL1PRCRESP = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.FindLevel1PrcResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='dfs.sls.level1prc.FindLevel1PrcResp.success', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='totalCount', full_name='dfs.sls.level1prc.FindLevel1PrcResp.totalCount', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='dfs.sls.level1prc.FindLevel1PrcResp.error', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='records', full_name='dfs.sls.level1prc.FindLevel1PrcResp.records', index=3,
...
_WRITELEVEL1PRCREQ = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.WriteLevel1PrcReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='record', full_name='dfs.sls.level1prc.WriteLevel1PrcReq.record', index=0,
...
_WRITELEVEL1PRCRESP = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.WriteLevel1PrcResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='dfs.sls.level1prc.WriteLevel1PrcResp.success', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='dfs.sls.level1prc.WriteLevel1PrcResp.error', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='record', full_name='dfs.sls.level1prc.WriteLevel1PrcResp.record', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEPROCSTATUSREQ = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.UpdateProcStatusReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='dfs.sls.level1prc.UpdateProcStatusReq.id', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status', full_name='dfs.sls.level1prc.UpdateProcStatusReq.status', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEPROCSTATUSRESP = _descriptor.Descriptor(
  ...
  full_name='dfs.sls.level1prc.UpdateProcStatusResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='dfs.sls.level1prc.UpdateProcStatusResp.success', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error', full_name='dfs.sls.level1prc.UpdateProcStatusResp.error', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Level1PrcRecord = _reflection.GeneratedProtocolMessageType('Level1PrcRecord', (_message.Message,), {
  ...
  '__module__' : 'sls.level1prc.level1prc_pb2'
  # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.Level1PrcRecord)
  })
...
FindLevel1PrcReq = _reflection.GeneratedProtocolMessageType('FindLevel1PrcReq', (_message.Message,), {
  ...
  'OtherConditionsEntry' : _reflection.GeneratedProtocolMessageType('OtherConditionsEntry', (_message.Message,), {
    ...
    '__module__' : 'sls.level1prc.level1prc_pb2'
    # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.FindLevel1PrcReq.OtherConditionsEntry)
    })
  ,
  'DESCRIPTOR' : _FINDLEVEL1PRCREQ,
  '__module__' : 'sls.level1prc.level1prc_pb2'
  # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.FindLevel1PrcReq)
  })
...
FindLevel1PrcResp = _reflection.GeneratedProtocolMessageType('FindLevel1PrcResp', (_message.Message,), {
  ...
  '__module__' : 'sls.level1prc.level1prc_pb2'
  # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.FindLevel1PrcResp)
  })
...
WriteLevel1PrcReq = _reflection.GeneratedProtocolMessageType('WriteLevel1PrcReq', (_message.Message,), {
  ...
  '__module__' : 'sls.level1prc.level1prc_pb2'
  # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.WriteLevel1PrcReq)
  })
...
WriteLevel1PrcResp = _reflection.GeneratedProtocolMessageType('WriteLevel1PrcResp', (_message.Message,), {
  ...
  '__module__' : 'sls.level1prc.level1prc_pb2'
  # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.WriteLevel1PrcResp)
  })
...
UpdateProcStatusReq = _reflection.GeneratedProtocolMessageType('UpdateProcStatusReq', (_message.Message,), {
  ...
  '__module__' : 'sls.level1prc.level1prc_pb2'
  # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.UpdateProcStatusReq)
  })
...
UpdateProcStatusResp = _reflection.GeneratedProtocolMessageType('UpdateProcStatusResp', (_message.Message,), {
  ...
  '__module__' : 'sls.level1prc.level1prc_pb2'
  # @@protoc_insertion_point(class_scope:dfs.sls.level1prc.UpdateProcStatusResp)
  })
...
_LEVEL1PRCSRV = _descriptor.ServiceDescriptor(
  name='Level1PrcSrv',
  full_name='dfs.sls.level1prc.Level1PrcSrv',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Find',
    full_name='dfs.sls.level1prc.Level1PrcSrv.Find',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Write',
    full_name='dfs.sls.level1prc.Level1PrcSrv.Write',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='dfs.sls.level1prc.Level1PrcSrv.UpdateProcStatus',
    index=2,
    containing_service=None,

...
def add_Level0PrcSrvServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Find': grpc.unary_unary_rpc_method_handler(
          servicer.Find,
          request_deserializer=sls_dot_level0prc_dot_level0prc__pb2.FindLevel0PrcReq.FromString,
          response_serializer=sls_dot_level0prc_dot_level0prc__pb2.FindLevel0PrcResp.SerializeToString,
      ),
      'Write': grpc.unary_unary_rpc_method_handler(
          servicer.Write,
          request_deserializer=sls_dot_level0prc_dot_level0prc__pb2.WriteLevel0PrcReq.FromString,
          response_serializer=sls_dot_level0prc_dot_level0prc__pb2.WriteLevel0PrcResp.SerializeToString,
      ),
      'UpdateProcStatus': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateProcStatus,
          request_deserializer=sls_dot_level0prc_dot_level0prc__pb2.UpdateProcStatusReq.FromString,
          response_serializer=sls_dot_level0prc_dot_level0prc__pb2.UpdateProcStatusResp.SerializeToString,
      ),
  }
